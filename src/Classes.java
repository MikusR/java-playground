public class Classes {
    public static void main(String[] args) {
        Knife knife1 = new Classes.Knife();
        Knife knife2 = new Classes.Knife("maker1", 3);
        Knife knife3 = new Classes.SwissKnife("maker2", 4, 54);
    ...
    public static class SwissKnife extends Knife {
        int functions;
